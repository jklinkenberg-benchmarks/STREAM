...
COMMON_COMPILE_FLAGS=-DSTREAM_ARRAY_SIZE=${STREAM_ARRAY_SIZE} -DNTIMES=${NTIMES} -DREAD_ONLY=${READ_ONLY} -DREAD_ONLY_REDUCTION=${READ_ONLY_REDUCTION} -DSTREAM_USE_HEAP=${STREAM_USE_HEAP}
